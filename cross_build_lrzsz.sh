...
LDFLAGS="$LDFLAGS -static" ./configure --build=host=x86_64-unknown-linux-gnu --host=aarch64-linux-gnu --target=aarch64-linux-gnu --enable-static
#LDFLAGS="-static $LDFLAGS" make 
make
